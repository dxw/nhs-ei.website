        ...
        for page in pages:
            ...
            try:
                ...
                if wp_id in self.cache:
                    ...
                    if page.get("page-components.php") or page.get(
                        "page-blog-landing.php"
                    ):
                ...
                self(
                    "slug",
                    "%d----%s" % (hash(page.get("slug")), page.get("wp_id")),
                    obj,
                )
                self(
                    "excerpt", trim_long_text(strip_tags(page.get("excerpt")), 250), obj
                )
                ...
                logger.warning(
                    "Validation error adding page with class %s, ID %s: %s"
                    % (obj.__class__, obj.wp_id, obj.obj.title)
                )
